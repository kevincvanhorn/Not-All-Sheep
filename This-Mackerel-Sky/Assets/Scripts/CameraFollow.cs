...
public class CameraFollow : MonoBehaviour {
    ...
    private void LateUpdate()
    {
        ...
        {
            Debug.LogError(player.hasLateralInput + " 0 - " + lookAheadStopped +" "+player.directionFacing + " " + focusArea.moveDist.x);
            ...
            else
            {
                if (!lookAheadStopped) {
                    ...
                    targetLookAheadX = curLookAheadX + (lookAheadDirX * lookAheadDistX - curLookAheadX)/3f; // 4: the fraction of smoothing - can be adjusted
                }
            }
        }
        //targetLookAheadX = lookAheadDirX * lookAheadDistX;
